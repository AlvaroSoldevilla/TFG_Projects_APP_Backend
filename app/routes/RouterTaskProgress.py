...
def get_task_progress_by_task_section(id_section: int, session: Session = Depends(get_session)):
    return stp.get_task_progress_by_task_section(id_section, session)
