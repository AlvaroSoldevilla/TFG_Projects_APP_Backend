...
@router.get("/{id}", dependencies=[Depends(JWTBearer())], response_model=ConceptBoardRead, status_code=200)
...
@router.get("/concept/{id}", dependencies=[Depends(JWTBearer())], response_model=list[ConceptBoardRead], status_code=200)
