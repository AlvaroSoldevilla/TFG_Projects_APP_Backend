...
async def update_concept(id: int, concept_update: ConceptUpdate):
    if sc.update_concept(id, concept_update):
...
async def get_concepts_by_project(id_project: int):
    return sc.get_concept_boards_by_project(id_project)
