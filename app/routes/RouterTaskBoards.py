...
@router.get("/{id}", dependencies=[Depends(JWTBearer())], response_model=TaskBoardRead, status_code=200)
...
@router.get("/project/{id}", dependencies=[Depends(JWTBearer())], response_model=list[TaskBoardRead], status_code=200)
